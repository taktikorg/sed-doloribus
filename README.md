...
[![npm](https://img.shields.io/npm/v/@taktikorg/sed-doloribus.svg)](https://www.npmjs.com/package/@taktikorg/sed-doloribus)
[![downloads](https://img.shields.io/npm/dt/@taktikorg/sed-doloribus.svg)](https://www.npmjs.com/package/@taktikorg/sed-doloribus)
[![types](https://img.shields.io/npm/types/@taktikorg/sed-doloribus.svg)](https://www.npmjs.com/package/@taktikorg/sed-doloribus)
[![licence](https://img.shields.io/github/license/mnasyrov/@taktikorg/sed-doloribus.svg)](https://github.com/taktikorg/sed-doloribus/blob/master/LICENSE)
[![Coverage Status](https://coveralls.io/repos/github/mnasyrov/@taktikorg/sed-doloribus/badge.svg?branch=main)](https://coveralls.io/github/mnasyrov/@taktikorg/sed-doloribus?branch=main)
...
| --------------------------------------------- | ------------------------------------------ | ---------------------------------------------------------- |
| [**@taktikorg/sed-doloribus**][@taktikorg/sed-doloribus/docs]             | Core elements, state and effect management | [Docs][@taktikorg/sed-doloribus/docs], [API][@taktikorg/sed-doloribus/api]             |
| [**@taktikorg/sed-doloribus-react**][@taktikorg/sed-doloribus-react/docs] | Tooling for React.js                       | [Docs][@taktikorg/sed-doloribus-react/docs], [API][@taktikorg/sed-doloribus-react/api] |
...
```
npm install @taktikorg/sed-doloribus @taktikorg/sed-doloribus-react --save
```
...
import { useConst, useObservable, useQuery } from '@taktikorg/sed-doloribus-react';
...
[@taktikorg/sed-doloribus/docs]: packages/@taktikorg/sed-doloribus/README.md
[@taktikorg/sed-doloribus/api]: packages/@taktikorg/sed-doloribus/docs/README.md
[@taktikorg/sed-doloribus-react/docs]: packages/@taktikorg/sed-doloribus-react/README.md
[@taktikorg/sed-doloribus-react/api]: packages/@taktikorg/sed-doloribus-react/docs/README.md
